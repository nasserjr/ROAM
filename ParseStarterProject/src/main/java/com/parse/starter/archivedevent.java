...
public class archivedevent extends AppCompatActivity {
    ...
    static Event archivedevent = new Event();
    String ticketnum;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.info:
                    archiveinfo fragment1 = new archiveinfo();
                ...
                if(e==null){
                    {
                        ...
                        if (objects.size() > 0) {
                            ...
                            for (ParseObject events : objects) {
                                ...
                                archivedevent.setId(events.getObjectId());
                                archivedevent.setInterest(events.getString("intereset"));
                                archivedevent.setName(events.getString("eventname"));
                                archivedevent.setCreatedby(events.getString("createdby"));
                                ...
                                archivedevent.setLocation(eventlocation);
                                archivedevent.setAddress(events.getString("address"));
                                archivedevent.setAllowedgender(events.getString("allowedgender"));
                                archivedevent.setCreatedAt(events.getDate("createdAt"));
                                archivedevent.setEventdate(events.getString("eventdate"));
                                archivedevent.setEventtime(events.getString("eventtime"));
                                archivedevent.setEventdescription(events.getString("description"));
                                archivedevent.setNumbofattendees(events.getInt("numberofattendees"));
                                archivedevent.setMinage(events.getInt("minage"));
                                archivedevent.setMaxage(events.getInt("maxage"));
                                archivedevent.setOthermanagers(events.<String>getList("othermanagers"));
                                /*
                                if(events.getList("requested")!=null){
                                    event.setRequested(events.<String>getList("requested"));
                                }*/
                                archivedevent.setEventpicture(events.getParseFile("eventpicture"));
                                archivedevent.setRate(events.getNumber("rate").floatValue());
