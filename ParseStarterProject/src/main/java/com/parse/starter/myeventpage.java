        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_information:
                    myeventinformation fragment1 = new myeventinformation();
                ...
                case R.id.navigation_discussion:
                    myeventdiscussion fragment2 = new myeventdiscussion();
                ...
                if(e==null){
                    {
                        ...
                        if (objects.size() > 0) {
                            ...
                            for (ParseObject events : objects) {
                                ...
                                myevent.setId(events.getObjectId());
                                myevent.setInterest(events.getString("intereset"));
                                myevent.setName(events.getString("eventname"));
                                myevent.setCreatedby(events.getString("createdby"));
                                ...
                                myevent.setAddress(events.getString("address"));
                                myevent.setAllowedgender(events.getString("allowedgender"));
                                myevent.setCreatedAt(events.getDate("createdAt"));
                                myevent.setEventdate(events.getString("eventdate"));
                                myevent.setEventtime(events.getString("eventtime"));
                                myevent.setEventdescription(events.getString("description"));
                                myevent.setNumbofattendees(events.getInt("numberofattendees"));
                                myevent.setMinage(events.getInt("minage"));
                                myevent.setMaxage(events.getInt("maxage"));
                                /*
                                if(events.getList("requested")!=null){
                                    event.setRequested(events.<String>getList("requested"));
                                }*/
                                myevent.setEventpicture(events.getParseFile("eventpicture"));
